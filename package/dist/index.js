...
`),p=`"use client";
  ...
  `;i.writeFileSync(s.join(n,`${t.toLowerCase()}-form.tsx`),p)}generateListPage(a,n){let e=d(a),t=h(e),o=`import { list${t} } from './actions';
  ...
  `,m=s.join(s.dirname(n),t.toLowerCase());i.mkdirSync(m,{recursive:!0}),i.writeFileSync(s.join(m,"page.tsx"),o);let l=s.join(n,"actions.ts"),p=i.readFileSync(l,"utf8");p.includes(`list${t}`)||(p+=`
  export async function list${t}() {
    // TODO: Implement fetching all ${t.toLowerCase()}
    console.log('Fetching all ${t.toLowerCase()}');
    return []; // Return an empty array for now
  }
  `,i.writeFileSync(l,p))}generateNewPage(a,n){let e=d(a),t=`
  ...
  `,o=s.join(n,"new");i.mkdirSync(o,{recursive:!0}),i.writeFileSync(s.join(o,"page.tsx"),t)}generateEditPage(a,n){let e=d(a),t=`
  import { ${e}Form } from '../../${e.toLowerCase()}-form';
  ...
  `,o=s.join(n,"[id]","edit");i.mkdirSync(o,{recursive:!0}),i.writeFileSync(s.join(o,"page.tsx"),t)}generateViewPage(a,n){let e=d(a),t=`
  ...
  `,o=s.join(n,"[id]");i.mkdirSync(o,{recursive:!0}),i.writeFileSync(s.join(o,"page.tsx"),t)}generateSchemas(a,n,e){let t=d(a),o=e.map((l,p)=>{let r=l.validations.length>0?`.${l.validations.join(".")}`:"",g=`${l.name}: z.${l.type}()${r}`;return p===0?g:`    ${g}`}).join(`,
`),m=`
  import { z } from 'zod';
  ...
  `;i.writeFileSync(s.join(n,"schemas.ts"),m)}generateActions(a,n){let e=d(a),t=`"use server";
